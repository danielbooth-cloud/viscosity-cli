...
func printUsage() {
	...
	fmt.Println("")
	fmt.Println("Usage:")
	fmt.Println("  vpn connect [connection-name]    Connect to a VPN connection (interactive mode if no name)")
	fmt.Println("  vpn on [connection-name]         Alias for connect")
	fmt.Println("  vpn disconnect [connection-name] Disconnect from VPN (all if no name specified)")
	fmt.Println("  vpn off [connection-name]        Alias for disconnect")
	fmt.Println("  vpn status                       Show status of all VPN connections")
	fmt.Println("  vpn list                         Alias for status")
	fmt.Println("  vpn help                         Show this help message")
	fmt.Println("")
	fmt.Println("Examples:")
	fmt.Println("  vpn connect                      Start interactive connection selection")
	fmt.Println("  vpn connect MyVPN                Connect to specific VPN")
	fmt.Println("  vpn on                           Start interactive connection selection")
	fmt.Println("  vpn disconnect MyVPN             Disconnect from specific VPN")
	fmt.Println("  vpn off                          Disconnect from all VPNs")
	fmt.Println("  vpn status                       Show all connections status")
}
